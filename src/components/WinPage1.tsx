...
const WinPage1: React.FC<WinPage1Props> = ({ onNavigate, onMarkAsPlayed, currentUser, onCreateUser }) => {
  ...
  const handleProceedToAccount = async () => {
    if (invitedFriends >= 3 && currentUser?.id) {
      ...
      try {
        const response = await apiService.updateQuizRewardStatus(parseInt(currentUser.id), 3);
            ...
            <div className="bg-white rounded-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
              <div className="p-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-bold text-gray-900">Invite 3 Friends to Withdraw</h3>
                  <button
                ...
                <div className="bg-gradient-to-r from-blue-50 to-blue-100 border border-blue-200 rounded-xl p-4 mb-6">
                  <div className="text-center">
                    <div className="text-xs text-gray-600 mb-2">Your Prize Amount</div>
                    <div className="text-xl font-bold text-blue-600 mb-3">₹{baseQuizWinnings}</div>
                ...
                <div className="space-y-3">
                  <div className="text-center">
                    <h4 className="font-semibold text-gray-800 mb-2 text-sm">Share via WhatsApp</h4>
